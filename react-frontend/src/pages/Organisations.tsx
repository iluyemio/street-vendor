...
const Organisations = () => {
    ...
    <nav className='nav'>
        <div className='container nav-inner'>
            ...
            <div className='nav-links' id="nav-links">
                ...
                <a href="/organisations" className="active">Organisations</a>
    ...
    <section className='page-hero'>
        <div className='container reveal'>
            <h1 className='page-title'>Approved Organisations</h1>
            <p className='page-lead'>Public directory of organisations operating within the verification system.</p>
        </div>
    </section>
    <section className='section' style={{"padding":"50px 0"}}>
        <div className='container grid-3'>
            <div className='card feature-card reveal'>
                ...
                <p className='muted' style={{"marginTop":"8px"}}>Youth-focused street periodical organisation</p>
                <div style={{"marginTop":"16px"}}><span className='badge green'>Approved</span></div>
            </div>
            <div className='card feature-card reveal'>
                <h3>Urban Routes</h3>
                <p className='muted' style={{"marginTop":"8px"}}>Community vendor network</p>
                <div style={{"marginTop":"16px"}}><span className='badge green'>Approved</span></div>
            </div>
        </div>
    </section>
