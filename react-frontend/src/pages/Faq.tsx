    ...
    <section className='section' style={{"padding":"50px 0"}}>
        <div className='container grid-2'>
            <div className='card o-card reveal'>
                <h3>How do I verify a vendor?</h3>
                <p className='muted' style={{"marginTop":"10px"}}>Enter the vendor ID or scan the QR code shown on their badge.
                </p>
            </div>
            <div className='card o-card reveal'>
                <h3>What does verified mean?</h3>
                <p className='muted' style={{"marginTop":"10px"}}>It means the vendor has been approved within the system and the
                    record is active.</p>
            </div>
        </div>
    </section>
